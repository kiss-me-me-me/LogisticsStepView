...
import com.example.xiefeng.myapplicationtest.R;
...
public class HorizontalStepsViewIndicator extends View
{
    ...
    private int mUnCompletedLineColor = ContextCompat.getColor(getContext(), android.R.color.black);//定义默认未完成线的颜色  definition mUnCompletedLineColor
